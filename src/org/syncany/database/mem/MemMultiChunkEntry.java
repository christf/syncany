 ...
 * {@link MemChunkEntry}s is stored. On a file, level, a multichunk is represented
 ...
 * and contains references to {@link MemChunkEntry}s. 
 * 
 * @author Philipp C. Heckel <philipp.heckel@gmail.com>
 */
public class MemMultiChunkEntry implements MultiChunkEntry {
    private byte[] id;    
    private List<ChunkEntryId> chunks;
        
    public MemMultiChunkEntry(byte[] id) {
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		MemMultiChunkEntry other = (MemMultiChunkEntry) obj;

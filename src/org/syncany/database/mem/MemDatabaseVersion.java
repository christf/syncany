...
public class MemDatabaseVersion implements DatabaseVersion {
    private MemDatabaseVersionHeader header; 
    ...
    public MemDatabaseVersion() {
    	header = new MemDatabaseVersionHeader();
	...
	public MemDatabaseVersionHeader getHeader() {
		return header;
	}
    ...
    @Override
  	...
  	public boolean equals(Object obj) {
  		...
  		if (getClass() != obj.getClass())
  			return false;
  		MemDatabaseVersion other = (MemDatabaseVersion) obj;
  		if (header == null) {

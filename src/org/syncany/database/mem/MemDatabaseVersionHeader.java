...
public class MemDatabaseVersionHeader implements DatabaseVersionHeader {
    ...
    public MemDatabaseVersionHeader() {
    	this.date = new Date();
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		MemDatabaseVersionHeader other = (MemDatabaseVersionHeader) obj;
		if (date == null) {
			if (other.date != null)
				return false;
